...
/**
 * It manages a single Hand of a game, asking for new cards and calculating the results.
 * The dealer must hit until a 17 is reached. Soft 17 and Hard 17 are managed depending on H17 option.
 * 
 * 
 * @author fabrizio
 *
...
public class HandController {
	...
	/**
	 * It return <code>true</code> if the dealer must add a new card otherwise <code>false</code>.
	 * The dealer must hit until a 17 is reached. Soft 17 and Hard 17 are managed depending on H17 option.
	 * 
